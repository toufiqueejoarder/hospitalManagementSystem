...
<div class="wrapper col1">
  <div id="container">
    <div id="content">
      ...
      <p>  The goal of Online Hospital management System is to improve the efficiency of the health by reducing the overall time and cost used to create documents and retrieve information.</p>
      <p>The main feature of is the Doctor appointment system which can provide the browser to get appointments from a doctor through internet instead of going there and fixing an appointment.</p>
      ...
      <div class="homecontent">
        <ul>
          ...
          <li class="last">
            ...
            <p class="imgholder"><a href="patientlogin.php"><img src="images/login01.jpg" alt="" style="width:286px;height:100px;"  /></a></p>
          </li>
        </ul>
        <div class="clear"></div>
      </div>
